...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-map"></i> <span class="nav-label">Maps</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{route('map.getmapa')}}">Mapa sin Key</a></li>
                    <li><a href="{{route('map.getmapados')}}">Mapa 2</a></li>
                    <li><a href="{{route('map.getmapatres')}}">Mapa SCZ</a></li>
                </ul>
            </li>
            <li>
